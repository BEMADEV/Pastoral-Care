...
If you wish to have the timeline moved along for a specific plugin, we can discuss your ministry sponsoring that project. We require a detailed request added to our support link and also an email to david.bensen@bemaservices.com to communicate the desire to sponsor (our minimum for work order is 4hrs). </div>
